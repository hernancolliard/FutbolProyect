...
export const metadata = {
  title: "Política de Privacidad - FutbolProyect",
  description: "Consulta nuestra política de privacidad para entender cómo FutbolProyect recopila, usa y protege tu información personal.",
};
